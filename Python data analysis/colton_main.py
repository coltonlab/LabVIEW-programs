...
# Having these as global variables makes it so we only need to update the file paths once.
file_path = 'C:/Data/2024-01-25/'
blank_file = file_path + 'Blank 3-F PESI 350-650nm 295K.xls'
trans_file = file_path + 'Trans 3-F PESI 350-650nm 16K.xls'

# If multiple csv files exist for a voltage series, this is a system for referencing the names of those files.
start_voltage = 100
end_voltage = 300
voltage_step = 50
voltages = [*range(start_voltage,end_voltage+voltage_step,voltage_step)]
end_of_filename = 'V EA 3-F PESI 350-650nm 16K.xls'
