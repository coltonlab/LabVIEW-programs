...
<Library LVVersion="23008000">
	...
	<Item Name="LPC query control mode.vi" Type="VI" URL="../LPC query control mode.vi"/>
	<Item Name="LPC query power.vi" Type="VI" URL="../LPC query power.vi"/>
	<Item Name="LPC query remote.vi" Type="VI" URL="../LPC query remote.vi"/>
	<Item Name="LPC query speak rate.vi" Type="VI" URL="../LPC query speak rate.vi"/>
	<Item Name="LPC query transmission.vi" Type="VI" URL="../LPC query transmission.vi"/>
	<Item Name="LPC query wavelength.vi" Type="VI" URL="../LPC query wavelength.vi"/>
