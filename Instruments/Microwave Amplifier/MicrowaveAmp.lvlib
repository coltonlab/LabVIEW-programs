...
<Library LVVersion="9008000">
	...
	<Item Name="send query micro amp.vi" Type="VI" URL="../send query micro amp.vi"/>
	<Item Name="format output.vi" Type="VI" URL="../format output.vi"/>
	<Item Name="send command micro amp.vi" Type="VI" URL="../send command micro amp.vi"/>
</Library>
